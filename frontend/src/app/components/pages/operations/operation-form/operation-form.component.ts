...
export class OperationFormComponent implements OnInit {
  ...
  initOperationFormGroup(): FormGroup {
    ...
    return this.fb.group({
      [this.FORM_CONTROLS.Wallet]: [this.operation ? { wallet: '62e8cf6f81564307e767adda', currency: this.operation.currency, name: this.operation.walletName } : '', Validators.required],
